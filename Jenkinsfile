    ...
    stages {
        ...
        stage('build') {
            steps {
              ...
              sh 'sudo -S docker run -d --name prometheuscont -p 9090:9090 -v /var/lib/jenkins/workspace/api-pipeline1 /prometheus.yml:/etc/prometheus/prometheus.yml prom/prometheus'
