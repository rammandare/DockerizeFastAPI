    ...
    stages {
        ...
        stage('build') {
            steps {
              ...
              sh 'sudo docker run -d --name prometheuscont -p 9090:9090 -v /var/lib/jenkins/workspace/api-ipeline1/prometheus.yml:/etc/prometheus/prometheus.yml prom/prometheus'
